...
export default class PlayPickleBallWebPart extends BaseClientSideWebPart<IPlayPickleBallWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IPlayPickleBallProps> = React.createElement(
      PlayPickleBall,
      {
